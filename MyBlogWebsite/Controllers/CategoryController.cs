...
namespace MyBlogWebsite.Controllers
{
	public class CategoryController : Controller
	{
		...
		public IActionResult Index(int id)
		{
			...
			//HTML KISMI HENÜZ GÜZEL VE DÜZENLİ DEĞİL, AÇILAN SAYFADA MAKALELER "KISMEN" GÖRÜNECEK. İLGİLİ MAKALEYİ GÖRÜNTÜLEMEK İÇİN BİR LINKE TIKLANMALI TIKLANDIĞINDA AÇILAN SAYFA ARTICLE CONTROLLER'DAN YONLENDIRILEN BIR VIEW'A GIDECEK. HER TIKLAMADA GORUNTULENME SAYISINI 1 ARTTIRACAK
		}
	}
}
